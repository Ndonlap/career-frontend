...
const MakeContribution = ({ tontine, member }) => {
  const contribution = tontine.contributionsList;
        ...
        <div className="p-6 bg-gray-100 h-full w-full">
          ...
          <div className="">
              ...
              <div className="bg-[#cae7f2] p-4 shadow rounded-lg flex justify-between items-center">
                <div>
                  ...
                  <h2 className="text-2xl font-bold">
                    CFA {tontine.contributionAmount}
                  </h2>
                </div>
                <MdOutlineCardTravel className="text-green-500 text-3xl" />
              </div>
            ...
            <div className="mb-6">
              ...
              {contribution.map((transaction, index) => (
                <div
                  key={index}
                ...
                >
                  <div className="flex items-center">
                    ...
                    /> */}
                    <div>
                      <p>Contribution From</p>
                      <p className="text-xs text-gray-400">
                        {/* {member.filter(opt => opt._id === transaction.userId)[0].name} */}
                      </p>
                    </div>
                  </div>
